...
<?php 
...
}else
 {
    ...
    if (mysqli_multi_query($con,$sql)) {
        $messages[] = "El folio ".$librofolio." ".$nextfolio." ".$librofolio2." ".$nextfolio2." ".$librofolio3." ".$nextfolio3.", han sido asignados.";
      
    } else {
        $errors[] = "Lo sentimos, asignación de folios ".$librofolio." ".$nextfolio." ".$librofolio2." ".$nextfolio2." ".$librofolio3." ".$nextfolio3." fallo. Por favor, regrese y vuelva a intentarlo.";
