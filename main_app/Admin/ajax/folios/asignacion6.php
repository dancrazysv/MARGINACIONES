...
$consu6 = "select * from margi where Iniciales1 <> '' AND busquedalf = '$librofolio6'";
...
$result6 = mysqli_query($con, $consu6);
...
<?php 
 ...
 { ?><div>
	 <div class="alert alert-danger" role="alert">
						<button type="button" class="close" data-dismiss="alert"><i class="far fa-times-circle"></i></button>
						<strong><i class="fas fa-bell"></i> Folios <?php echo $librofolio6;?> <?php echo $nextfolio6;?> no asignados una o más marginaciones ya fueron asignadas a otro usuario.</strong>
</div></div>
...
<?php 
...
}else
 {
	...
	$sql .= "UPDATE margi SET Iniciales1 = '$iniciales' WHERE busquedalf = '$librofolio6';";
	$sql .= "UPDATE margi SET Iniciales1 = '$iniciales' WHERE busquedalf = '$nextfolio6';";
    ...
    if (mysqli_multi_query($con,$sql)) {
        $messages[] = "El folio ".$librofolio." ".$nextfolio." ".$librofolio2." ".$nextfolio2." ".$librofolio3." ".$nextfolio3." ".$librofolio4." ".$nextfolio4." ".$librofolio5." ".$nextfolio5.", ".$librofolio6." ".$nextfolio6." han sido asignados.";
      
    } else {
        $errors[] = "Lo sentimos, asignación de folios ".$librofolio." ".$nextfolio." ".$librofolio2." ".$nextfolio2." ".$librofolio3." ".$nextfolio3." ".$librofolio4." ".$nextfolio4." ".$librofolio5." ".$nextfolio5.", ".$librofolio6." ".$nextfolio6." fallo. Por favor, regrese y vuelva a intentarlo.";
