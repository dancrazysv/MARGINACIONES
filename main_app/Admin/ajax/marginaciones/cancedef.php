...
if ($tipocd == 'viudef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon .", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . $sexocandef . "," .  $datecd . "" .$vacio . ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $vacio.  ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$id2=intval($_POST['edit_idcan']+1);
	// UPDATE data into database
		$TxtMargi1 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" .$vacio .  ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
