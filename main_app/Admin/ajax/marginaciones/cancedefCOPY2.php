...
if ($tipocd == 'nacdef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Cancelase la presente partida de nacimiento de ". trim(titleCase($nombrecd)) . $sexocandef . ", en virtud de haber fallecido" .  $datecd . "" . $lugarcd . ", según partida de defunción" . $pardef . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipocd == 'viudef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon .", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . $sexocandef . "," .  $datecd . "" . $lugarcd . ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipocd == 'matdef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Cancelase la presente partida por haber fallecido " . $sexocdfa . "" . trim(titleCase($nombrecd)) . $sexocandef . ", " . $datecd . ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $lugarcd .  ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = "Cancelase la presente partida por haber fallecido " . $sexocdfa . "" . trim(titleCase($nombrecd)) . $sexocandef . ", " .  $datecd . ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$id2=intval($_POST['edit_idcan']+1);
	// UPDATE data into database
		$TxtMargi1 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $lugarcd .  ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $lugarcd .  ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
	...
	$TxtMargi3 = "Cancelase la presente partida por haber fallecido " . $sexocdfa . "" . trim(titleCase($nombrecd)) . $sexocandef . ", " .  $datecd . ", según partida de defunción" . $pardef  . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
