...
$TxtMargi1 = trim(titleCase($_POST['edit_el2'])) . " " .  "" . $conv2 . "" . $apellido2 . "" . $conocido . " contrajo matrimonio con " . trim(titleCase($_POST['Nellamat'])) . " " .  "" . $conv6 . "" . $apellidoella2 . "" .$conocidoella . ", el día " . $dia_B . "" . $mes_B . "" . $anio_B . $opcionnotario . $casootro . "" . trim($_POST['LugarB'],'utf-8') . "; los contrayentes optan por el Régimen Patrimonial " . trim(titleCase($uregimen)) . "; la contrayente ". $usara ." ". trim(titleCase($uapellidos)) .". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
        

    $sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopart', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdf', cargor = '$carg', estado = '$est', TipoMargi= 'MNAC', revestado = 'revisado1', fechaevento = '$originalDate' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
<?php 
    ...
    $id=intval($_POST['edit_id']);
    // UPDATE data into database
            $TxtMargi1 = trim(titleCase($_POST['Nellamat'])) . " " .  "" . $conv6 . "" . $apellidoella2 . "" . $conocida . " contrajo matrimonio con " . trim(titleCase($_POST['edit_el2'])) . " " .  "" . $conv2 . "" . $apellido2 . "". $conocidoel . ", el día " .  $dia_B . "" . $mes_B . "" . $anio_B . $opcionnotario . $casootro . "" . trim($_POST['LugarB'],'utf-8') . "; los contrayentes optan por el Régimen Patrimonial " . trim(titleCase($uregimen)) . "; la contrayente ". $usara ." ". trim(titleCase($uapellidos)) .". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($value_el == 'male' and $regimenv == '' and $apellidosv == 'Avalue' ) {
    ...
    $id=intval($_POST['edit_id']);
    // UPDATE data into database
           $TxtMargi1 = trim(titleCase($_POST['edit_el2'])) . " " .  "" . $conv2 . "" . $apellido2 . "". $conocido . " contrajo matrimonio con " .  trim(titleCase($_POST['Nellamat'])) . " " .  "" . $conv6 . "" . $apellidoella2 . "". $conocidoella . ", el día " .  $dia_B . "" . $mes_B . "" . $anio_B . $opcionnotario . $casootro . "" . trim($_POST['LugarB'],'utf-8') . "; la contrayente ". $usara ." ". trim(titleCase($uapellidos)) .". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
<?php 
    ...
    $id=intval($_POST['edit_id']);
    // UPDATE data into database
            $TxtMargi1 = trim(titleCase($_POST['Nellamat'])) . " " .  "" . $conv6 . "" . $apellidoella2 . "". $conocida . " contrajo matrimonio con " .  trim(titleCase($_POST['edit_el2'])) . " " .  "" . $conv2 . "" . $apellido2 . "". $conocidoel . ", el día " .  $dia_B . "" . $mes_B . "" . $anio_B . $opcionnotario . $casootro . "" . trim($_POST['LugarB'],'utf-8') . "; la contrayente ". $usara ." ". trim(titleCase($uapellidos)) .". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi1 = $nombresactael . " contrajo matrimonio con " . $nombresactaella . ", el día " . $dia_acta . "" . $mes_Bacta . "" . $anio_Bacta . "; ante " . trim(titleCase($actaalcalde)) . ", Alcalde Municipal, en San Salvador, San Salvador; los contrayentes optan por el Régimen Patrimonial " . trim(titleCase($actaregimen)) . "; la contrayente ". $usaraacta ." ". trim(titleCase($uapellidosacta)) .". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
    ...
    $sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopart', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdf', cargor = '$carg', estado = '$est', TipoMargi= 'MNAC', revestado = 'revisado1', fechaevento = '$actafechamatri' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
$TxtMargi2 = $nombresactaella . " contrajo matrimonio con " . $nombresactael . ", el día " . $dia_acta . "" . $mes_Bacta . "" . $anio_Bacta . "; ante " . trim(titleCase($actaalcalde)) . ", Alcalde Municipal, en San Salvador, San Salvador; los contrayentes optan por el Régimen Patrimonial " . trim(titleCase($actaregimen)) . "; la contrayente ". $usaraacta ." ". trim(titleCase($uapellidosacta)) .". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
    ...
    $sql2 = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi2) . "', AnioP = '$AnioP2', LibroP = '" . Espacios($LibroP2) . "', NPartida = '" . Espacios($NPartida2) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopart2', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdf2', cargor = '$carg', estado = '$est', TipoMargi= 'MNAC', revestado = 'revisado1', fechaevento = '$actafechamatri' WHERE id = '$id2' AND Iniciales1 = '$Iniciales'";
