...
$TxtMargi1 = trim(titleCase($niden)) . "" . $sexoid . " " . trim(titleCase($conide)) . "; según Escritura Pública de Identidad" . $dateid . ", ante " . trim(titleCase($nombreiden)) . ", " . trim($cargoid) . " en " . trim($lugarid) . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipoide == 'idedef' ) {
	...
	$id=intval($_POST['edit_ididen']);
	// UPDATE data into database
$TxtMargi1 = trim(titleCase($niden2)) . "" . $sexoid2 . " " . trim(titleCase($conide2)) . "; según Escritura Pública de Identidad" . $dateid . ", ante " . trim(titleCase($nombreiden)) . ", " . trim($cargoid) . " en " . trim($lugarid) . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = trim(titleCase($niden)) . "" . $sexoid2 . " " .  trim(titleCase($conide)) . "; según Escritura Pública de Identidad" . $dateid . ", ante " . trim(titleCase($nombreiden)) . ", " . trim($cargoid) . " en " . trim($lugarid) . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
