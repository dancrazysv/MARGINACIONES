...
$TxtMargi1 = "Ampliase el cargo que ejerce de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", " . $tutorpara . " según oficio número " . $oficiotuto2 . "" . $fechartuto . ", por " . $portuto . " de " . $lugartuto . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipotu == 'tutoria' and $tipotuto == 'inicio' and  $sentenciatu == 'ejecututo1' and $ejecutoriatu == 'ejecututo2') {
	...
	$id=intval($_POST['edit_idaut']);
	// UPDATE data into database
$TxtMargi1 = "Disciérnase el cargo de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", según sentencia pronunciada" . $hora_tuto . "" . $datetuto . "" . $por_tuto . "; ejecutoriada" . $hora_tutos . "" . $datetutos . "" . $por_tutos . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipotu == 'tutoria' and $tipotuto == 'final' and  $sentenciatu == 'ejecututo1' and $ejecutoriatu == 'ejecututo2') {
	...
	$id=intval($_POST['edit_idaut']);
	// UPDATE data into database
$TxtMargi1 = "Decretase la finalización  del cargo de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", según sentencia pronunciada" .  $hora_tuto . "" . $datetuto . "" . $por_tuto . "; ejecutoriada" . $hora_tutos . "" . $datetutos . "" . $por_tutos . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipotu == 'tutoria' and $tipotuto == 'inicio' and  $sentenciatu == 'ejecututo1' and $ejecutoriatu == '') {
	...
	$id=intval($_POST['edit_idaut']);
	// UPDATE data into database
$TxtMargi1 = "Disciérnase el cargo de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", según sentencia pronunciada" .  $hora_tuto . "" . $datetuto . "" . $por_tuto . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipotu == 'tutoria' and $tipotuto == 'final' and  $sentenciatu == 'ejecututo1' and $ejecutoriatu == '') {
	...
	$id=intval($_POST['edit_idaut']);
	// UPDATE data into database
$TxtMargi1 = "Decretase la finalización  del cargo de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", según sentencia pronunciada" .  $hora_tuto . "" . $datetuto . "" . $por_tuto . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipotu == 'tutoria' and $tipotuto == 'inicio' and  $sentenciatu == '' and $ejecutoriatu == 'ejecututo2') {
	...
	$id=intval($_POST['edit_idaut']);
	// UPDATE data into database
$TxtMargi1 = "Disciérnase el cargo de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", ejecutoriada" . $hora_tutos . "" . $datetutos . "" . $por_tutos . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipotu == 'tutoria' and $tipotuto == 'final' and  $sentenciatu == '' and $ejecutoriatu == 'ejecututo2') {
	...
	$id=intval($_POST['edit_idaut']);
	// UPDATE data into database
$TxtMargi1 = "Decretase la finalización  del cargo de " . trim($cargotu) . " a " . trim(titleCase($nombretu)) . ", respecto de " . trim(titleCase($respectotu)) . ", ejecutoriada" . $hora_tutos . "" . $datetutos . "" . $por_tutos . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
