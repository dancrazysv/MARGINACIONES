...
if ($confecha != "")
{
$TxtMargi1 = trim($txtotr) . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
}
else
{
