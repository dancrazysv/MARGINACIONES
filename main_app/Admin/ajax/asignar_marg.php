...
$iniciales = ( empty($_POST['inicialesfoliom']) )   ? NULL : $_POST['inicialesfoliom'];
	...
	$sql = "select * from margi where TxtMargi1 <> '' AND LibroO = '$librofolio' AND NMargi1 = '$nmargi'";
$result = mysqli_query($con, $sql);
...
<?php 
 ...
 {	
	...
	$sql = "UPDATE margi SET Iniciales1 = '$iniciales' WHERE LibroO = '$librofolio' AND NMargi1 = '$nmargi'";
