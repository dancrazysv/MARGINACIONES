...
<input type='hidden' value=\"$nombrejefe\" name='registrador1' readonly=\"readonly\" id='registrador1'><input type='hidden' value=\"$cargodeljefe\" name='cargoregis1' readonly=\"readonly\" id='cargoregis1'></td>
        </tr></tr>";
...
<input type='hidden' value=\"$nombrejefe\" name='registrador2' readonly=\"readonly\" id='registrador2'><input type='hidden' value=\"$cargodeljefe\" name='cargoregis2' readonly=\"readonly\" id='cargoregis2'></td>
        </tr>		</tr>";
...
<input type='hidden' value=\"$nombrejefe\" name='registrador3' readonly=\"readonly\" id='registrador3'><input type='hidden' value=\"$cargodeljefe\" name='cargoregis3' readonly=\"readonly\" id='cargoregis3'></td>
        </tr></tr>";
...
<input type='hidden' value=\"$nombrejefe\" name='registrador4' readonly=\"readonly\" id='registrador4'><input type='hidden' value=\"$cargodeljefe\" name='cargoregis4' readonly=\"readonly\" id='cargoregis4'></td>
        </tr></tr>";
...
while($row = mysqli_fetch_array($result)){
	...
	if ($row[22] == "completo" || $row[22] == "revisado2" || $row[22] == "revisado3" || $row[22] == ""){
