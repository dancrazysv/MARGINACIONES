					...
					<table width="100%">
					    <tr>
					      <td colspan="5"><p> Seleccione la marginación a crear:&nbsp;&nbsp;
					        ...
					        <input type="radio"  id="tipo4" name="gender" value="acta" required />
					        <label for="tipo4">Por Acta&nbsp;&nbsp;</label>
					        </p>
		...
		<div class="modal-dialog ">
            ...
            <tr><td width="50%" align="center"><b> Último Libro:</td><td width="50%" align="center"><b>Siguiente Libro:</b></td></tr>
              ...
              <tr>
				...
				<td ><input id="librou" type="text" class="form-control line vld draw"  name="librou"  style="Background-color: #121c4e;color:#efb810;font-size: 25px;text-align: center;" readonly></td><td><input id="librou2" type="text" class="form-control line vld draw"  name="librou2" style="Background-color: #121c4e;color:#efb810;font-size: 25px;text-align: center;" readonly></td>			  
...
<div id="addusuario" class="modal fade" spellcheck="true">
    ...
    <OPTION value="Ciudaddelgado">Ciudad Delgado</OPTION>
...
<div id="asignarfolio" class="modal fade" >
   ...
   <tr><td width="30%">Seleccione el usuario para acreditar Folios</td><td width="5%" rowspan="6"></td><td width="30%">Digita # de Libro</td><td width="5%" rowspan="6"><td width="30%"></td></tr><tr><td >
				  
	
				  <select class="form-control"  name="usuariofolio" id="usuariofolio"  required>
        <option value="0" >Seleccione Usuario:</option>
				    <?php
          $query = $mysqli -> query ("SELECT * FROM usuarios WHERE estado='Activo' and esta_habilitado='1' order by nombre");
          while ($valores = mysqli_fetch_array($query)) {
            echo '<option value="'.$valores[id].'" data-iniciales3="'.$valores[iniciales].'">'.$valores[nombre].'&nbsp;&nbsp;&nbsp;&nbsp;</option>';
          }
        ?>
				 		  </select></td><td><input type="text" class="form-control validar" name="librofolio" id="librofolio" placeholder="Libro"  maxlength="3" required > <input type="hidden"  name="idusuariofolio" id="idusuariofolio" ><input type="hidden"  name="inicialesfolio" id="inicialesfolio">
				</td></tr>

				<tr><td>Digita los numeros de folios a asignar</td></tr>

				<tr><td><input type="text" class="form-control validar" name="folioasig1" id="folioasig1" placeholder="Folio_1"  maxlength="3" required ></td><td> <input type="text" class="form-control validar" name="folioasig2" id="folioasig2" placeholder="Folio_2"  maxlength="3" required ></td><td><input type="text" class="form-control validar" name="folioasig3" id="folioasig3" placeholder="Folio_3"  maxlength="3" required ></td></tr>
				
          <tr><td><input type="text" class="form-control validar" name="folioasig4" id="folioasig4" placeholder="Folio_4"  maxlength="3" required ></td><td> <input type="text" class="form-control validar" name="folioasig5" id="folioasig5" placeholder="Folio_5"  maxlength="3" required ></td><td><input type="text" class="form-control validar" name="folioasig6" id="folioasig6" placeholder="Folio_6"  maxlength="3" required ></td></tr> 
              ...
              <tr>
				...
				<td colspan="3" >* Debes de seleccionar el usuario y luego asignar el libro y folios, recuerda que los folios no deben de ser mayor a 499, solo puedes ingresar números impares.</td>
...
<div id="asignarmarginacion" class="modal fade" >
   ...
   <td>Digita libro:</td><td>Número de Marginación:</td></tr><tr><td >
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form name="revform" id="revform" autocomplete="off">
					...
					<div class="modal-header">						
						<h4 class="modal-title"> Revisión de <b><font color="#121c4e">Marginación</font></b></h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="far fa-times-circle"></i></button>
					</div>
					<div class="modal-body ">
