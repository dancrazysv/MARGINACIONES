...
$sqlACTIVA2 = "SELECT * FROM margi WHERE estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
...
$sqlCMAT = "SELECT * FROM margi WHERE TipoMargi='MCMAT' AND estado='Activa' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultCMAT = mysqli_query($con,$sqlCMAT);
$numeroCMAT = mysqli_num_rows($resultCMAT);
...
$sqlOTRA = "SELECT * FROM margi WHERE TipoMargi='MOTRA' AND estado='Activa' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultOTRA = mysqli_query($con,$sqlOTRA);
$numeroOTRA = mysqli_num_rows($resultOTRA);


$sqlMAT2 = "SELECT * FROM margi WHERE TipoMargi='MNAC' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultMAT2 = mysqli_query($con,$sqlMAT2);
$numeroMAT2 = mysqli_num_rows($resultMAT2);

$sqlDIV2 = "SELECT * FROM margi WHERE TipoMargi='MDIV' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultDIV2 = mysqli_query($con,$sqlDIV2);
$numeroDIV2 = mysqli_num_rows($resultDIV2);

$sqlCMAT2 = "SELECT * FROM margi WHERE TipoMargi='MCMAT' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultCMAT2 = mysqli_query($con,$sqlCMAT2);
$numeroCMAT2 = mysqli_num_rows($resultCMAT2);

$sql152 = "SELECT * FROM margi WHERE TipoMargi='MA15' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$result152 = mysqli_query($con,$sql152);
$numero152 = mysqli_num_rows($result152);

$sql172 = "SELECT * FROM margi WHERE TipoMargi='MA17' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$result172 = mysqli_query($con,$sql172);
$numero172 = mysqli_num_rows($result172);

$sqlCNDEF2 = "SELECT * FROM margi WHERE TipoMargi='MCNDEF' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultCNDEF2 = mysqli_query($con,$sqlCNDEF2);
$numeroCNDEF2 = mysqli_num_rows($resultCNDEF2);

$sqlVIU2 = "SELECT * FROM margi WHERE TipoMargi='MVIU' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultVIU2 = mysqli_query($con,$sqlVIU2);
$numeroVIU2 = mysqli_num_rows($resultVIU2);

$sqlCMDEF2 = "SELECT * FROM margi WHERE TipoMargi='MCMDEF' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultCMDEF2 = mysqli_query($con,$sqlCMDEF2);
$numeroCMDEF2 = mysqli_num_rows($resultCMDEF2);
	
$sqlIDEN2 = "SELECT * FROM margi WHERE TipoMargi='MIDEN' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultIDEN2 = mysqli_query($con,$sqlIDEN2);
$numeroIDEN2 = mysqli_num_rows($resultIDEN2);

$sqlADEC2 = "SELECT * FROM margi WHERE TipoMargi='MADEC' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultADEC2 = mysqli_query($con,$sqlADEC2);
$numeroADEC2 = mysqli_num_rows($resultADEC2);

$sqlMUMAT2 = "SELECT * FROM margi WHERE TipoMargi='MUMAT' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultMUMAT2 = mysqli_query($con,$sqlMUMAT2);
$numeroMUMAT2 = mysqli_num_rows($resultMUMAT2);

$sqlCREG2 = "SELECT * FROM margi WHERE TipoMargi='MCREG' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultCREG2 = mysqli_query($con,$sqlCREG2);
$numeroCREG2 = mysqli_num_rows($resultCREG2);

$sqlSREG2 = "SELECT * FROM margi WHERE TipoMargi='MSREG' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultSREG2 = mysqli_query($con,$sqlSREG2);
$numeroSREG2 = mysqli_num_rows($resultSREG2);

$sqlTUTO2 = "SELECT * FROM margi WHERE TipoMargi='MTUTO' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultTUTO2 = mysqli_query($con,$sqlTUTO2);
$numeroTUTO2 = mysqli_num_rows($resultTUTO2);

$sqlAUTO2 = "SELECT * FROM margi WHERE TipoMargi='MAUTO' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultAUTO2 = mysqli_query($con,$sqlAUTO2);
$numeroAUTO2 = mysqli_num_rows($resultAUTO2);

$sqlREPRE2 = "SELECT * FROM margi WHERE TipoMargi='MREPRE' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultREPRE2 = mysqli_query($con,$sqlREPRE2);
$numeroREPRE2 = mysqli_num_rows($resultREPRE2);


$sqlRECO2 = "SELECT * FROM margi WHERE TipoMargi='MRECO' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultRECO2 = mysqli_query($con,$sqlRECO2);
$numeroRECO2 = mysqli_num_rows($resultRECO2);

$sqlSUB2 = "SELECT * FROM margi WHERE TipoMargi='MSUB' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultSUB2 = mysqli_query($con,$sqlSUB2);
$numeroSUB2 = mysqli_num_rows($resultSUB2);

$sqlADO2 = "SELECT * FROM margi WHERE TipoMargi='MADO' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultADO2 = mysqli_query($con,$sqlADO2);
$numeroADO2 = mysqli_num_rows($resultADO2);

$sqlLEG2 = "SELECT * FROM margi WHERE TipoMargi='MLEG' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultLEG2 = mysqli_query($con,$sqlLEG2);
$numeroLEG2 = mysqli_num_rows($resultLEG2);


$sqlREPO2 = "SELECT * FROM margi WHERE TipoMargi='MREPO' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
$resultREPO2 = mysqli_query($con,$sqlREPO2);
$numeroREPO2 = mysqli_num_rows($resultREPO2);

$sqlOTRA2 = "SELECT * FROM margi WHERE TipoMargi='MOTRA' AND estado='Sin Efecto' AND FechaC BETWEEN '$fecha1' AND '$fecha2'";
...
$dompdf->loadHtml('
<table width="100%">
<tr><td align="center"><img src="../ajax/logo_pb.png"></td></tr>	
...
<tr align="center" style="height: 80px;
  ...
  padding-left: 10px;"><b>Sin Efecto</b></td></b></tr>
  ...
  padding-left: 10px;">Cancelación Matrimonio por Divorcio:</td>
	  <td align="right" style="width: 25px;
  padding-right: 10px;">'.$numeroCMAT.'</td>  <td align="right" style="width: 25px;
  padding-right: 10px;">'.$numeroCMAT2.'</td></tr>
	<tr style="height: 80px;
	border-left: #043569 1px solid;
	border-right: #043569 1px solid; background:#F0FFF0">
	<td style="height: 25px;width: 250px;
...
<tr style="height: 80px;
  ...
  padding-right: 10px;">'.$numeroACTIVA.'</td>
	...
	background:#F0FFF0">
	<td style="height: 25px;width: 200px;
  padding-left: 10px;">Total de Marginaciones Sin Efecto:</td><td align="right" style="width: 50px;
