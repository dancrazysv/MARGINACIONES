...
<?php 
 ...
 else
 {
    ...
    $sql = "UPDATE margi SET TxtMargi1 = '', AnioP = '', LibroP = '', NPartida = '', InicialesPDF = '', FechaC = '', TipoP = '', HoraC = '', lineapdf = '', registrador = '', nmargpdf = '', cargor = '', estado = '', TipoMargi = '', revestado = '' WHERE LibroO='$libestadovaciar' and NMargi1='$margestadovaciar' ";
