...
<tr><td width=200 rowspan=2><img src=logo_pb.png width="400" height="52"></td><td rowspan=2 width=10><img src=sep_log.png></td>
...
<head>
    ...
    <style>        
        @import url("fonts\Archivo-SemiBold");
        .joti-font {font-family: "Archivo", font-size: 12px;}
    </style>
</head>
<body><table width=520 border=0 class="joti-font" >
<tr><td width=200 rowspan=2><img src=logo_pb.png width="400" height="52"></td><td rowspan=2 width=10><img src=sep_log.png></td>
...
<body><table width=520 border=0 class="joti-font" >
<tr><td rowspan=2 width=10><img src=sep_log.png></td><td rowspan=2 width=10><img src=sep_log.png></td><td rowspan=2 width=10><img src=sep_log.png></td><td width=200 rowspan=2><img src=logo_pb.png width="400" height="52"></td><td rowspan=2 width=10><img src=sep_log.png></td>
<td width=160 align=left valign=top>LIBRO DE MARGINACIONES:&nbsp;<b><font size=+1>'.$folionum.'</font></b></td></tr>
<tr><td align=left valign=top>FOLIO:&nbsp;'.$foliotext1.'</td></tr><tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
