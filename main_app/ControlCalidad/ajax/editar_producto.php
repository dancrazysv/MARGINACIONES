...
$numvar = ( empty($_POST['folvar']) ) ? NULL : $_POST['folvar'];
...
// Hora de varias 1
$hora_var = ( empty($_POST['horavar1']) )   ? NULL : $_POST['horavar1'];
...
// Fecha de varias 1
$datevar = ( empty($_POST['fechavar1']) )   ? NULL : $_POST['fechavar1'];
...
// Hora de varias 2
$hora_vari = ( empty($_POST['horavar2']) )   ? NULL : $_POST['horavar2'];
...
// Fecha de varias 2
$datevari = ( empty($_POST['fechavar2']) )   ? NULL : $_POST['fechavar2'];
...
$pardef = " número " . $numpcdef2 . ", folio " . $foliocdef2 . ", libro " . $librocdef2 . ", del año " . $aniocdef2 . ", extendida por la Alcaldía de " . trim(titleCase($alcaldiacd)) . "";
...
$recepapel3 =  ( empty($_POST['otroapellido']) ) ? NULL : $_POST['otroapellido'];
	$usoape14 = "nombre " . $recepapel3;	
	$usoape24 = trim(titleCase($usoape14));
$usoape34 = substr($usoape24,6);
$otroape = trim($usoape34);	
...
if ($cargoopcion == 'ccargo' and $nombreopcion == 'mnombre' ){
	...
	$casootro =  ", " . titleCase($optioncaso) . ", en ";
...
////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////
////////// Validacion marginacion

include ("marginaciones/ccontrol.php");
