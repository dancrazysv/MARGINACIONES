...
function numtoletrasPDFM3($xcifra)
{
    $xarray = array(0 => "CERO",
        1 => "UNA", "DOS", "TRES", "CUATRO", "CINCO", "SEIS", "SIETE", "OCHO", "NUEVE",
                    ...
                    case 1: // checa las centenas
                        if (substr($xaux, 0, 3) < 100) { // si el grupo de tres dígitos es menor a una centena ( < 99) no hace nada y pasa a revisar las decenas
                            ...
                            if (TRUE === array_key_exists($key, $xarray)){  // busco si la centena es número redondo (100, 200, 300, 400, etc..)
                                $xseek = $xarray[$key];
                                $xsub = subfijo3($xaux); // devuelve el subfijo correspondiente (Millón, Millones, Mil o nada)
...
function fechaATextoM3($fecha){
  ...
  $anio= numtoletrasPDFM3($fecha_separada[2]);
