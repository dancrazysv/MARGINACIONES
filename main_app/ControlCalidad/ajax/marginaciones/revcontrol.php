<?php
	...
	$lugar = 	( empty($_POST['validarlugar']) )   ? NULL : $_POST['validarlugar'];
...
if($lugar=="Ayutuxtepeque") { 	
	...
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($textorevi2) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "',  TipoP = '$tiporevi2', lineapdf = '" . Espacios($lugardos) . "', revestado = 'completo5', margfin= 'fin' WHERE id = '$id'";
