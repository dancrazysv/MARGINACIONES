<?php
	...
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($textorevi) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "',  TipoP = '$tiporevi', lineapdf = 'FIRMASAMIA.jpg', revestado = '$estadorevi1' WHERE id = '$id'";
