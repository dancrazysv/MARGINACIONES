...
$TxtMargi1 = "Marginase la presente Partida de Nacimiento de " . trim(titleCase($prnacnombre)) . $sexoidprnac ." y téngase por renunciada a la Nacionalidad por Nacimiento, según sentencia pronunciada" .  $hora_prnac . "" . $dateprnac . "" . $por_prnac . ", emitida por la Dirección General de Migración y Extranjería del Ministerio de Justicia y Seguridad Pública, de conformidad a los artículos noventa y uno de la Constitución de La República de El Salvador, ciento cincuenta y siete y doscientos setenta y siete de la Ley Especial de Migración y Extranjería.". " Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparprnac', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numpdfprnac', cargor = '$carg', estado = '$est', TipoMargi = 'MPNAC', revestado = 'revisado1' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
$TxtMargi1 = "Cancelase la marginación de renuncia de Nacionalidad por Nacimiento de " . trim(titleCase($prnacnombre)) . $sexoidprnac ." y téngase por recuperada su calidad de salvadoreño por Nacimiento, según sentencia pronunciada" .  $hora_prnac . "" . $dateprnac . "" . $por_prnac . ", emitida por la Dirección General de Migración y Extranjería del Ministerio de Justicia y Seguridad Pública, de conformidad a los artículos noventa y uno de la Constitución de La República de El Salvador, doscientos setenta y ocho de la Ley Especial de Migración y Extranjería.". " Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparprnac', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numpdfprnac', cargor = '$carg', estado = '$est', TipoMargi = 'MRNAC', revestado = 'revisado1' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
