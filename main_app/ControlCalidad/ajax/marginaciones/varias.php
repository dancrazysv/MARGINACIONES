...
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " . $numvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2. ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'subsi' and $tipovareje == 'ejecuvar' and $tipovarsen == 'ejecuvar2') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " . $numvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2 . ", según sentencia pronunciada" .  $hora_var . "" . $datevar . "" . $por_var . "; ejecutoriada" . $hora_vari . "" . $datevari . "" . $por_vari . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'subsi' and $tipovareje == 'ejecuvar' and $tipovarsen == '') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " . $numvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2 . ", según sentencia pronunciada" .  $hora_var . "" . $datevar . "" . $por_var . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'subsi' and $tipovareje == '' and $tipovarsen == 'ejecuvar2') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " .  $numvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2 . ", ejecutoriada" . $hora_vari . "" . $datevari . "" . $por_vari . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'repo' ) {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida ha sido repuesta por la número " . $numvar2 . ", folio " . $numvar2 . ", libro número " . $librovar2 . " de Reposiciones, del año " . $aniovar2 . ", según" . $tipoacta . "" . $actavar2 . "," . $fecharepo . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
