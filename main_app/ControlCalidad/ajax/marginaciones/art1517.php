...
if ($art151 == '15_1' and $sexo151 == 'male' and $sexo152 == '') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Rectificase la presente partida de nacimiento, en el sentido que el nombre correcto del inscrito es: ". trim(titleCase($nombre151)) . ". Según Resolución emitida por la Licenciada Karla Mariela Olivares Martínez, Jefe del Registro del Estado Familiar" .  $f_art151 . ", sobre la base del Artículo diecisiete de la Ley Transitoria del Registro del Estado Familiar y de los Regímenes Patrimoniales del Matrimonio y Artículo quince de la Ley del Nombre de la Persona Natural. Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($art151 == '17_1') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Rectificase la presente partida" . $tipo17 . "" . $nombre171 . ", en el sentido que " . trim($sentido1) .  ". Según Resolución emitida por la Licenciada Karla Mariela Olivares Martínez, Jefe del Registro del Estado Familiar". $f_art171 .", sobre la base del Artículo diecisiete de la Ley Transitoria del Registro del Estado Familiar y de los Regímenes Patrimoniales del Matrimonio. Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = "Rectificase la presente partida" . $tipo172 . "" . $nombre172 . ", en el sentido que " . trim($sentido2) .  ". Según Resolución emitida por la Licenciada Karla Mariela Olivares Martínez, Jefe del Registro del Estado Familiar". $f_art172 .", sobre la base del Artículo diecisiete de la Ley Transitoria del Registro del Estado Familiar y de los Regímenes Patrimoniales del Matrimonio. Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
