...
if ($tiporeg == 'uni' and $tipoju == 'ejecutoriajuzreg1' and $tipoju2 == '') {
	...
	$id=intval($_POST['edit_idreg']);
	// UPDATE data into database
$TxtMargi1 = "Declárase LA UNION NO MATRIMONIAL de " . trim(titleCase($nregel)) . $unioncono . $antecederegdos . trim(titleCase($nregella)) . $unioncono2 . ", según sentencia pronunciada" .  $hora_reg . "" . $datereg . "" . $por_reg . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tiporeg == 'uni' and $tipoju == '' and $tipoju2 == 'ejecutoriajuzreg2') {
	...
	$id=intval($_POST['edit_idreg']);
	// UPDATE data into database
$TxtMargi1 = "Declárase LA UNION NO MATRIMONIAL de " . trim(titleCase($nregel)) . $unioncono . $antecederegdos . trim(titleCase($nregella)) . $unioncono2 . ", ejecutoriada" . $hora_regu . "" . $dateregu . "" . $por_regu . ". Alcaldía de San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
