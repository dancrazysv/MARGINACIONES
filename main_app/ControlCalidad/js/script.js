...
$( function() {
    $("#optionvar").change( function() {
        if ($(this).val() === "") {
            $("#txtotrovar").prop("disabled", true);
			document.getElementById("txtotrovar").value = "";
        } else if ($(this).val() === "Notario en "){
            $("#txtotrovar").prop("disabled", true);
			document.getElementById("txtotrovar").value = "";
        }else if ($(this).val() === "Alcalde Municipal en "){
			...
			document.getElementById("txtotrovar").focus();
...
function myFunction() {
  document.getElementById("edit_product").reset();
	document.getElementById("partida2").style.display = 'none';
	document.getElementById("treg").disabled = '';
	document.getElementById("usoA").disabled = '';
	document.getElementById("apellidoellaid").disabled = '';
	document.getElementById("apellidoelid").disabled = '';
	document.getElementById("edit_notro").disabled = 'true';
}
...
$("#conotxtcandef1").prop("disabled", true);
				...
				$("#chklibrotipo").attr("checked", false);
				$("#librotipo").prop("disabled", true);
				...
				$("#alcaldiadef2").prop("disabled", true);
        ...
        $("#stfolio2").click(function () {
            if ($("#datosfcd2").is(":visible")) {
			  ...
			  document.getElementById("datosfcd2").style.display = '';	
				...
				$("#alcaldiadef2").prop("disabled", false);				
...
$(document).ready(function () {
        $("#tipo2var").click(function () {
            if ($("#senvar1").is(":visible")) {
				...
				$("#folvar").prop("disabled", false);
				$("#numvar").prop("disabled", false);
				$("#optionsnad").prop("disabled", false);
