...
<div id="editProductModal" class="modal fade" spellcheck="true">
		<div class="modal-dialog  modal-lg">
			...
			<table width="100%" >
					    <tr>
					      <td colspan="5"><p> Seleccione Documento Origen:&nbsp;&nbsp;
							
							  <input type="radio"  id="tipodoc1" name="tipodoc" value="escritura"  required />
					   
					        <label for="tipodoc1">Escritura Pública&nbsp;&nbsp;</label>
					        <input type="radio"  id="tipodoc2" name="tipodoc" value="acta" required />
					        <label for="tipodoc2">Acta de Matrimonio&nbsp;&nbsp;</label>
					        <input type="radio"  id="tipodoc3" name="tipodoc" value="partida" required />
					        <label for="tipodoc3">Partida de Matrimonio</label>
					       					        </p>
...
<table name="descritura" id="descritura" style="display: none" width="100%">
	<tr>
		
		<td width="14%">Número Escritura:</td>
					      <td width="35%"><input type="text" class="form-control validar" name="escrinumero" required id="escrinumero" value="" >
					        </td>	
<td ></td>
	<td ></td>
	</tr>
			...
			<table name="dacta" id="dacta" style="display: none" width="100%">
			<tr>			
				      <td width="14%">Año:</td>
					      <td  width="35%"><input type="text" class="form-control validar" name="actanummat" maxlength="4" id="actanummat"  onBlur="return validarRango(this);" required></td>
					      
							<td rowspan="2" width="2%"></td>
							<td width="14%">Libro:</td>
					      <td width="35%"><input type="text" class="form-control" name="libroacta" id="libroacta" maxlength="4" style="text-transform: uppercase;" value="" required></td>
				        </tr>
					    <tr>
					      <td >Num. Acta/Partida:</td>
					      <td ><input type="text" class="form-control" name="partidaacta" maxlength="5" id="partidaacta" style="text-transform: uppercase;" value="" required></td>
					      <td ><input type="checkbox"  value="Tipo de Libro" name="chknumpartida" onchange="librotipomatri.disabled = !this.checked;librotipomatri.focus()" id="chknumpartida" onClick="librotipomatri.value=''"><label for="chknumpartida">Tipo:&nbsp;&nbsp;&nbsp;</label></td>
                
				<td colspan="3"><input id="librotipomatri" type="text" class="form-control" name="librotipomatri" placeholder="Tipo de Libro o Letra"  onkeypress="return soloLetras(event);" required disabled></td>
				        </tr>
	...
	<table name="matriactas" id="matriactas" style="display: none" width="100%">
						
					    <tr>
					      <td colspan="5" align="center">
							
							  <h4>
							  <span class="label label-primary">Digita los datos de folicación del acta de Matrimonio</span></h4></td>
				        </tr>
					    <tr>
					      <td width="14%">Acta:</td>
					      <td  width="35%"><input type="text" class="form-control" name="consuacta" id="consuacta" required></td></tr>
					      <tr>							
							<td width="14%">Nombre el:</td>
					      <td width="35%"><input type="text" class="form-control" name="nombresel" id="nombresel"  required readonly></td>
<td rowspan="3" width="2%"></td><td width="14%">Nombre ella:</td>	
					      <td width="35%"><input type="text" class="form-control" name="nombresella" id="nombresella"  required readonly></td>
				        </tr>
									 
 <tr>							
							<td width="14%">Municipio el:</td>
					      <td width="35%"><input type="text" class="form-control" name="muniel" id="muniel"  required readonly></td>
</td><td width="14%">Municipio ella:</td>	
					      <td width="35%"><input type="text" class="form-control" name="muniella" id="muniella"  required readonly></td>
				        </tr>

 <tr>							
							<td width="14%">Seleccionar el:</td>
					      <td width="35%"><input type="checkbox"  value="actael" name="actael" id="actael" onchange="javascript:showContent();"> <label for="actael">El&nbsp;&nbsp;</label></td>
</td><td width="14%">Seleccionar ella:</td>	
					      <td width="35%"><input type="checkbox"  value="actaella" name="actaella" id="actaella" onchange="javascript:showContentdos();"> <label for="actaella">Ella&nbsp;&nbsp;</label></td>
				        </tr>

<input type="hidden" name="actanombresel" id="actanombresel" >
<input type="hidden" name="actaapeunoel" id="actaapeunoel" >
<input type="hidden" name="actaapedosel" id="actaapedosel" >
<input type="hidden" name="actanombresella" id="actanombresella" >
<input type="hidden" name="actaapeunoella" id="actaapeunoella" >
<input type="hidden" name="actaapedosella" id="actaapedosella" >
<input type="hidden" name="actaalcalde" id="actaalcalde" >
<input type="hidden" name="actaregimen" id="actaregimen" >
<input type="hidden" name="actausoapellidos" id="actausoapellidos" >
<input type="hidden" name="actafechamatri" id="actafechamatri" >
<input type="hidden" name="actaconoel" id="actaconoel" >
<input type="hidden" name="actaconoella" id="actaconoella" >
					    ...
					    <tr>
					      <td ><input type="checkbox"  value="Rvalue" name="OptionRA" id="OptionRA"  disabled>
					        <label for="OptionRA">Régimen:&nbsp;&nbsp;&nbsp;</label></td>
					      <td ><input id="treg" type="text" class="form-control" name="RegimenB"  onKeyPress="return soloLetras(event);"  required disabled></td>
							<td colspan="2"></td>
...
<table id="tramitediv" style="display: none">
<tr>
							
		<td width="20%">Busqueda por trámite: </td><td width="20%"><input type="text" class="form-control" name="numtramitediv" id="numtramitediv"/></td><td width="60"></td>
...
<?php
  ...
  <tr>
    ...
    <OPTION Value="jefe1">Karla Mariela Olivares Martínez</OPTION>
    
</td></tr>	
				<tr><td >Cargo:</td><td colspan="2">
					<SELECT name="cargos" class="form-control seleccion" id="cargos" required >
    <OPTION Value="cargo1">Registrador del Estado Familiar</OPTION>
	...
	<OPTION Value="cargo7">Jefe del Registro del Estado Familiar</OPTION>
</td></tr>				
...
<div id="art17" class="modal fade"  spellcheck="true">
		<div class="modal-dialog  modal-lg">
			<div class="modal-content" >
				<form name="art17form" id="art17form" autocomplete="off">
				  <div class="modal-header">						
						<h4 class="modal-title"> Marginación Artículo <b><font color="#121c4e">Quince, Cuarenta, Rectificaciones y Subsanaciones</font></b></h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="far fa-times-circle"></i></button>
					</div>
					<div class="modal-body">
  ...
  <label for="art17_1">Art. 40&nbsp;</label>
  
	<input type="radio"  id="art17_3" name="art1517" value="17_3" required />
	<label for="art17_3">Rectificación Notario</label>

<input type="radio"  id="art17_4" name="art1517" value="17_4" required />
	<label for="art17_4">Subsanación Admin.</label>
<input type="radio"  id="art17_5" name="art1517" value="17_5" required />
	<label for="art17_5">Subsanación Notarial</label>

	<input type="radio"  id="art17_6" name="art1517" value="17_6" required />
	<label for="art17_6">Subsanación Judicial</label></td></tr>
  ...
  <label for="art15_2s">Masculino&nbsp;&nbsp;</label>
            ...
            <tr>
				...
				<td width="56%"><input type="text" class="form-control" name="nombre151" id="nombre151" placeholder="Apellidos" style="text-transform: uppercase" onkeypress="return soloLetras(event);" disabled required></td>
            <td width="2%"></td>
  ...
  <label for="art15_2_1s">Masculino&nbsp;&nbsp;</label>
   ...
   <table name="art171" id="art171" style="display: none" width="100%">
	   ...
	   <tr><td ><input type="checkbox"  name="17nombre" id="17nombre" value="nombres17" disabled><label for="17nombre">A nombre de:</label></td>
		   <td colspan="4"><input type="text" class="form-control" style="text-transform: uppercase" name="nombre17" id="nombre17" placeholder="Nombres y Apellidos" disabled required ></td></tr>
            <tr>
                ...
                <td  >&#8226; Art. 40, En el sentido que:<br>&#8226; Subsanación, en el sentido que, se omitió:</td>
          ...
          <td width="2%"></td>
             <td width="14%" >Fecha de resolución, escritura u oficio:</td>
	   ...
	   <tr><td ><input type="checkbox"  name="17nombre2" id="17nombre2" value="nombres172" disabled><label for="17nombre2">A nombre de:</label></td>
	...
	<table width="100%" name="datosnotrecti" id="datosnotrecti" style="display: none">  
				...
				<tr><td>No. de Escritura:</td><td><input type="text" class="form-control validar" name="lugarrecti" required id="lugarrecti"  placeholder="No. de Escritura" maxlength="3"  disabled></td>
...
<table width="100%" name="numref" id="numref" style="display: none">  
					<tr><td width="14%">Número de Ref. Resolución Motivada:</td><td width="35%"><input type="text" class="form-control" name="refreso" required id="refreso" placeholder="# Referencia" onkeypress="return soloLetras(event);" disabled></td>
							
						<td rowspan="2" width="2%"></td>
						<td width="14%"></td><td width="35%"></td>
							</tr>					
	 ...
	 <?php
			...
			<table name="partida173" id="partida173" style="display: none" width="100%">
				<tr><h4>
				  <td colspan="5" align="center">
					...
					<h4>  <span class="label label-primary">Digita los datos de folicación de la partida a marginar Art. 40 O Subsanación</span></h4></td></tr>
			<tr>  
			<td width="14%">Año Part.:</td>
        ...
        ?>	
				...
				<tr><td colspan="5" align="center"><h4><span class="label label-primary">Digita los datos de folicación de la segunda partida a marginar Art. 40 o Subsanación (x2)</span></h4></td></tr>
			  <tr>  
			<td width="14%">Año Part. 2:</td>
...
<div id="cancedef" class="modal fade" spellcheck="true">
  ...
  <label for="sexocd2">Masculino&nbsp;&nbsp;</label></td></tr>
				...
				<tr><td >Viud@:&nbsp;&nbsp;</td><td><input type="text" class="form-control" name="viudo" required id="viudo" placeholder="Nombre de la persona viud@" onkeypress="return soloLetras(event);" style="text-transform:uppercase;" disabled></td></tr>
				 	...
				 	<tr>
					<td ><input type="checkbox"  value="conocidoscandef1" name="conocidocandef1" onchange="conotxtcandef1.disabled = !this.checked;conotxtcandef1.focus()" id="conocidocandef1" onClick="conotxtcandef1.value=''" disabled><label for="conocidocandef1">Conocid@ por:&nbsp;&nbsp;&nbsp;</label></td>
  ...
  <label for="sexocd22">Masculino&nbsp;&nbsp;</label></td></tr>
           ...
           <td width="15%">Nombre Fallecid@:</td>
				<td ><input type="text" class="form-control" name="edit_ncd" required id="edit_ncd" style="text-transform:uppercase;"placeholder="Nombre de la persona fallecida" onkeypress="return soloLetras(event);"  disabled>
				 	...
				 	<tr>
					<td ><input type="checkbox"  value="conocidoscandef2" name="conocidocandef" onchange="conotxtcandef2.disabled = !this.checked;conotxtcandef2.focus()" id="conocidocandef" onClick="conotxtcandef2.value=''" disabled><label for="conocidocandef">Conocid@ por:&nbsp;&nbsp;&nbsp;</label></td>
			...
			<tr>
			  ...
			  <td><textarea class="form-control" name="conoid2" id="conoid2" required placeholder="Todos los nombres según escritura, seprados por coma (,)" onkeypress="return soloLetras2(event);" disabled></textarea></td>
				...
				<td ><input type="date" class="max-today form-control" name="Fechaid" id="Fechaid"  min="1900-01-01" max="2030-12-31" required pattern="\d{4}-\d{2}-\d{2}" style="width: auto" disabled></td>			
											...
											<tr>
           <td width="14%">Número de Escritura</td>
				<td ><input type="text" class="form-control validar" name="edit_nid" required id="edit_nid"  placeholder="Número de Escritura" disabled>
           		              </td>
<td></td><td>Número de Escritura</td>
        <td ><input type="text" class="form-control validar" name="edit_nid2" required id="edit_nid2"  placeholder="Número de Escritura" disabled>
           		              </td>
            </tr>
			...
			<tr><td colspan="5" align="center"><h4><span class="label label-primary">Digita los datos de folicación de la part|ida a marginar (Nacimiento)</span></h4></td><tr>
			<tr>  
			<td width="14%">Año:</td>
...
<div id="varias" class="modal fade" spellcheck="true">
  ...
  <label for="tipo5var">Reposición Acuerdo / Acta&nbsp;&nbsp;</label><input type="hidden" name="edit_idvar" id="edit_idvar" >
		...
		<table width="100%"  name="foliacionvar1" id="foliacionvar1" style="display: none">
			...
			<tr>  
			<td width="14%">Año:</td>
				<td width="35%" ><input type="text" class="form-control validar" placeholder="Año de Libro" name="aniovar" value="<?php echo date("Y"); ?>" onblur="return validarRango(this);"  maxlength="4" id="aniovar" required disabled></td>
			...
			<td >Num. Partida</td>
				<td ><input type="text" class="form-control validar" maxlength="5" name="numvar" id="numvar"  placeholder="# de Partida" required disabled></td>
            </tr>
			<tr>  
			<td >Tipo:</td>
        ...
        <div class="modal-content">
            <form name="otroform" id="otroform" autocomplete="off">
                ...
                <div class="modal-body">
                    <table width="100%">
                        <tr>
                            <td>Utiliza esta opción cuando la marginación no esté contemplada en este sistema</td>
                        </tr>
                    </table>

                    <table id="tableotr" width="100%">
                        <tr>
                            <td width="14%">Tipo de Marginación:</td>
                            <td width="86%">
                                <select class="form-control" name="tipomargvacia" id="tipomargvacia" required style="width:100%">
                        ...
                        <tr id="filaBusquedaResolucion" style="display:none;">
                            <td>Búsqueda Resolución:</td>
                            <td>
                                <div style="display:flex; gap:5px; margin-top:5px;">
                                    <input type="text" class="form-control" id="buscarResolucion" placeholder="Ejemplo: 2026-82" style="flex:1;">
                                    <button type="button" class="btn btn-info" id="btnBuscarResolucion">Buscar</button>
                                </div>
                                <small class="text-muted">Formato: Año-Correlativo</small>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="txtotra" id="txtotra" placeholder="Digita el texto de la marginación sin punto final..." rows="5" onkeypress="return soloLetras(event);" required></textarea>
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" id="chkfecha" value="chkfecha">
                                <label for="chkfecha">Con fecha Actual</label>
                            </td>
                            <td colspan="3">. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador...</td>
                        </tr>
                    </table>

                    <table id="tableotra" width="100%" style="margin-top:15px;">
                        <tr>
                            <td colspan="4" align="center"><h4><span class="label label-primary">Datos de foliación de la partida</span></h4></td>
                        </tr>
                        <tr>
                            <td width="25%">Año:</td>
                            <td width="25%"><input type="text" class="form-control" name="aniootr" id="aniootr" onblur="return validarRango(this);" maxlength="4" required></td>
                            <td width="25%" align="center">Libro Part.:</td>
                            <td width="25%"><input type="text" class="form-control" name="librootr" id="librootr" maxlength="4" style="text-transform: uppercase;" required></td>
                        </tr>
                        <tr>
                            <td width="25%">Num. Part.:</td>
                            <td width="25%"><input type="text" class="form-control" name="numotr" id="numotr" maxlength="5" style="text-transform: uppercase;" required></td>
                            <td align="center">Tipo:</td>
                            <td>
                                <select class="form-control" name="tipootr" id="tipootr" required>
                                    <?php
                                    $queryP = $mysqli->query("SELECT * FROM tipo_partida");
                                    while ($valP = mysqli_fetch_array($queryP)) {
                                        echo '<option value="'.$valP['iniciales_partida'].'">'.$valP['nombre_partida'].'</option>';
                                    }
                                    ?>
                                </select>
                                <input type="hidden" value="<?php echo $inicialesuser; ?>" name="edit_ini">
                            </td>
                        </tr>
                    </table>
                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    const selectTipo = document.getElementById("tipomargvacia");
    const filaBusqueda = document.getElementById("filaBusquedaResolucion");
    const inputBusqueda = document.getElementById("buscarResolucion");
    const btnBuscar = document.getElementById("btnBuscarResolucion");
    const textareaTexto = document.getElementById("txtotra");
    const chkFecha = document.getElementById("chkfecha");

    // Lógica para mostrar búsqueda de resolución
    selectTipo.addEventListener("change", function () {
        let texto = selectTipo.options[selectTipo.selectedIndex].text;
        if (texto.includes("Art. 40") || texto.includes("Rectificación") || texto.includes("Subsanación")) {
            filaBusqueda.style.display = "table-row";
        } else {
    ...
    // Búsqueda de resolución por Fetch
    btnBuscar.addEventListener("click", function () {
        let valor = inputBusqueda.value.trim();
        if (valor === "" || !valor.includes("-")) {
            alert("Formato Año-Correlativo (Ej: 2026-82)");
            return;
        }
        btnBuscar.disabled = true;
        btnBuscar.innerHTML = "Buscando...";

        fetch("/main_app/Sansalvador/buscar_resolucion.php", {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
            body: "anio=" + encodeURIComponent(valor.split("-")[0]) + "&correlativo=" + encodeURIComponent(valor.split("-")[1])
        })
        .then(res => res.json())
        .then(data => {
            ...
            if (data && data.success) {
                textareaTexto.value = data.texto;
            } else {
                alert("No se encontró la resolución.");
            }
        }).catch(() => {
            btnBuscar.disabled = false;
            btnBuscar.innerHTML = "Buscar";
    ...
    // Lógica de insertar fecha actual
    chkFecha.addEventListener("change", function() {
        if (this.checked) {
            let textoActual = textareaTexto.value.trim();
            const f = new Date();
            ...
            let anioLetras = (f.getFullYear() === 2026) ? "dos mil veintiséis" : f.getFullYear(); 
            let fechaLetras = `${dias[f.getDate() - 1]} de ${meses[f.getMonth()]} de ${anioLetras}`;
            const fraseFinal = `. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, ${fechaLetras}.`;

            if (textoActual.endsWith(".")) {
                textareaTexto.value = textoActual + "" + fraseFinal.substring(2);
            } else {
                textareaTexto.value = (textoActual === "") ? fraseFinal : textoActual + "" + fraseFinal;
            }
        }
    });
});
...
<div id="alertaanio"  data-backdrop="static" class="modal fade" tabindex="-1" data-focus-on="input:first" style="display: ;">
		<div class="modal-dialog ">
			<div class="modal-content">
					...
					<div class="modal-body">
					<center>	<big><big><big><font color="#34495e">Debes de digitar un año comprendido en el rango entre 1869 y <?php echo date("Y");?></font></big></big></big></center>
