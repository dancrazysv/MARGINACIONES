...
if ($tipocd == 'nacdef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Cancelase la presente partida de nacimiento de ". trim(titleCase($nombrecd)) . $sexocandef . ", en virtud de haber fallecido" .  $datecd . "" . $lugarcd . ", según partida de defunción" . $pardef . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparcandef', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numparpdfcd', cargor = '$carg', estado = '$est', TipoMargi= 'MCNDEF', revestado = 'revisado1' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tipocd == 'viudef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon .", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . $sexocandef . "," .  $datecd . "" . $lugarcd . ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparviudez', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numparpdfcd', cargor = '$carg', estado = '$est', TipoMargi= 'MVIU', revestado = 'revisado1' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tipocd == 'matdef') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Cancelase la presente partida por haber fallecido " . $sexocdfa . "" . trim(titleCase($nombrecd)) . $sexocandef . ", " . $datecd . ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparcanmat', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numparpdfcd', cargor = '$carg', estado = '$est', TipoMargi= 'MCMDEF', revestado = 'revisado1' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
$TxtMargi2 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $lugarcd .  ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql2 = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi2) . "', AnioP = '$AnioP2', LibroP = '" . Espacios($LibroP2) . "', NPartida = '" . Espacios($NPartida2) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparviudez', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numparpdfcd2', cargor = '$carg', estado = '$est', TipoMargi= 'MVIU', revestado = 'revisado1' WHERE id = '$id2' AND Iniciales1 = '$Iniciales'";
...
$TxtMargi2 = "Cancelase la presente partida por haber fallecido " . $sexocdfa . "" . trim(titleCase($nombrecd)) . $sexocandef . ", " .  $datecd . ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql2 = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi2) . "', AnioP = '$AnioP2', LibroP = '" . Espacios($LibroP2) . "', NPartida = '" . Espacios($NPartida2) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparcanmat', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numparpdfcd2', cargor = '$carg', estado = '$est', TipoMargi= 'MCMDEF', revestado = 'revisado1' WHERE id = '$id2' AND Iniciales1 = '$Iniciales'";
...
$id2=intval($_POST['edit_idcan']+1);
	// UPDATE data into database
		$TxtMargi1 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $lugarcd .  ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi2 = "Marginase la presente partida de nacimiento de ". trim(titleCase($viudocd)) . $sexocdcon . ", por haber fallecido su cónyuge " . trim(titleCase($nombrecd)) . "," .  $datecd . "" . $lugarcd .  ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
	...
	$TxtMargi3 = "Cancelase la presente partida por haber fallecido " . $sexocdfa . "" . trim(titleCase($nombrecd)) . $sexocandef . ", " .  $datecd . ", según partida de defunción" . $pardef  . ". Distrito de San Salvador Sede, Municipio de San Salvador Centro, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql3 = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi3) . "', AnioP = '$AnioP3', LibroP = '" . Espacios($LibroP3) . "', NPartida = '" . Espacios($NPartida3) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparcanmat', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$numparpdfcd3', cargor = '$carg', estado = '$est', TipoMargi= 'MCMDEF', revestado = 'revisado1' WHERE id = '$id3' AND Iniciales1 = '$Iniciales'";	
