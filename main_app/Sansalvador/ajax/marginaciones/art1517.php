...
if ($art151 == '15_1' and $sexo151 == 'male' and $sexo152 == '') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Subsánese el presente asiento de nacimiento en el sentido que, se omitió la asignación de un segundo apellido del inscrito, por consiguiente usará sus apellidos como ". trim(titleCase($nombre151)) . ", según Resolución Motivada". $f_art151 ." emitida por la licenciada KARLA MARIELA OLIVARES MARTÍNEZ, Registrador del Estado Familiar de San Salvador Centro. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual."."; 

	
		
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$Tipof17', TipoMargi = 'MA15', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdf17', cargor = '$carg', estado = '$est', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($art151 == '15_1' and $sexo151 == 'female' and $sexo152 == '') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Subsánese el presente asiento de nacimiento en el sentido que, se omitió la asignación de un segundo apellido de la inscrita, por consiguiente usará sus apellidos como ". trim(titleCase($nombre151)) . ", según Resolución Motivada". $f_art151 ." emitida por la licenciada KARLA MARIELA OLIVARES MARTÍNEZ, Registrador del Estado Familiar de San Salvador Centro. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual."."; 
...
if ($art151 == '17_1') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Rectifíquese el presente asiento" . $tipo17 . " en el sentido que, " . trim($sentido1) .  " y no como erróneamente se encuentra consignado, según Resolución Motivada". $f_art171 ." emitida por la licenciada KARLA MARIELA OLIVARES MARTÍNEZ, Registrador del Estado Familiar de San Salvador Centro. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($art151 == '17_2') {
	...
	// UPDATE data into database
			$TxtMargi1 = "Rectificase la presente partida" . $tipo17 . "" . $nombre171 . ", en el sentido que " . trim($sentido1) .  ". Según Resolución emitida por la licenciada KARLA MARIELA OLIVARES MARTÍNEZ Registrador del Estado Familiar del Distrito de San Salvador Sede,  San Salvador Centro, San Salvador". $f_art171 .", sobre la base del Artículo diecisiete de la Ley Transitoria del Registro del Estado Familiar y de los Regímenes Patrimoniales del Matrimonio. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		
		
		
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$Tipof17', TipoMargi = 'MA17', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdf17', cargor = '$carg', estado = '$est', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";

$TxtMargi2 = "Rectificase la presente partida" . $tipo172 . "" . $nombre172 . ", en el sentido que " . trim($sentido2) .  ". Según Resolución emitida por la licenciada KARLA MARIELA OLIVARES MARTÍNEZ Registrador del Estado Familiar del Distrito de San Salvador Sede,  San Salvador Centro, San Salvador". $f_art172 .", sobre la base del Artículo diecisiete de la Ley Transitoria del Registro del Estado Familiar y de los Regímenes Patrimoniales del Matrimonio. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi1 = "Rectifíquese el presente asiento" . $tipo17 . " en el sentido que, " . trim($sentido1) .  " y no como erróneamente se encuentra consignado, según Escritura Pública número ". $numesrectin ."". $f_art171 ." ante ".$cargorecti." ".trim(titleCase($nombrerecti)).". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($art151 == '17_4') {
	...
	$TxtMargi1 = "Subsánese el presente asiento" . $tipo17 . " en el sentido que, se omitió " . trim($sentido1) .  ", según Resolución Motivada". $f_art171 ." emitida por la licenciada KARLA MARIELA OLIVARES MARTÍNEZ, Registrador del Estado Familiar de San Salvador Centro. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi1 = "Subsánese el presente asiento" . $tipo17 . " en el sentido que, se omitió " . trim($sentido1) .  ", según Escritura Pública número ". $numesrectin ."". $f_art171 ." ante ".$cargorecti." ".trim(titleCase($nombrerecti)).". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$TxtMargi1 = "Subsánese el presente asiento" . $tipo17 . " en el sentido que, se omitió " . trim($sentido1) .  ", según Oficio número ". $numesrectin ."". $f_art171 ." ante ".$cargorecti." ".trim(titleCase($nombrerecti)).". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
