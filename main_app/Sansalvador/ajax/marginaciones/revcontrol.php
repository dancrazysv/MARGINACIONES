<?php
	...
	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($textorevi2) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "',  TipoP = '$tiporevi2', lineapdf = 'FIRMAKARLACENTRO.jpg', revestado = 'completo2' WHERE id = '$id'";
