...
$TxtMargi1 = "Declárase la Unión no Matrimonial de " . trim(titleCase($nregel)) . $unioncono . $antecederegdos . trim(titleCase($nregella)) . $unioncono2 . ", según sentencia pronunciada" .  $hora_reg . "" . $datereg . "" . $por_reg . ", ejecutoriada" . $hora_regu . "" . $dateregu . "" . $por_regu . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipoparreg', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$regpdf', cargor = '$carg', estado = '$est', TipoMargi = 'MUMAT', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tiporeg == 'uni' and $tipoju == 'ejecutoriajuzreg1' and $tipoju2 == '') {
	...
	$id=intval($_POST['edit_idreg']);
	// UPDATE data into database
$TxtMargi1 = "Declárase la Unión no Matrimonial de " . trim(titleCase($nregel)) . $unioncono . $antecederegdos . trim(titleCase($nregella)) . $unioncono2 . ", según sentencia pronunciada" .  $hora_reg . "" . $datereg . "" . $por_reg . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tiporeg == 'uni' and $tipoju == '' and $tipoju2 == 'ejecutoriajuzreg2') {
	...
	$id=intval($_POST['edit_idreg']);
	// UPDATE data into database
$TxtMargi1 = "Declárase la Unión no Matrimonial de " . trim(titleCase($nregel)) . $unioncono . $antecederegdos . trim(titleCase($nregella)) . $unioncono2 . ", ejecutoriada" . $hora_regu . "" . $dateregu . "" . $por_regu . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tiporeg == 'creg') {
	...
	$id=intval($_POST['edit_idreg']);
	// UPDATE data into database
$TxtMargi1 = "Constituyese el Régimen Patrimonial de " . trim($nuevoreg) . ", en el presente asiento, de conformidad a Escritura Pública otorgada ante " . trim(titleCase($nfunreg)) . ", " . trim($cargoreg) . ", en " .  trim($lugarreg) . "" . $dateregc . ", Régimen Patrimonial que optan en esta fecha los contrayentes " . trim(titleCase($nregel)) . $unioncono . $antecederegdos .  trim(titleCase($nregella)) . $unioncono2 . ", según Artículo ochenta y cuatro del Código de Familia. Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$matrimoniop', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$regpdf', cargor = '$carg', estado = '$est', TipoMargi = 'MCREG', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tiporeg == 'sreg') {
	...
	$id=intval($_POST['edit_idreg']);
	// UPDATE data into database
$TxtMargi1 = "Sustituyese el Régimen Patrimonial en el presente asiento por el cual habían optado los contrayentes " . trim(titleCase($nregel)) . $unioncono . $antecederegdos . trim(titleCase($nregella)) . $unioncono2 . "" . $daterego . ", por el Régimen patrimonial de: " . trim($nuevoreg) . ", de conformidad a Escritura Pública de Capitulaciones Matrimoniales referente a Sustitución del Régimen Patrimonial, otorgada por " . trim(titleCase($nfunreg)) . ", " . trim($cargoreg) . ", en " .  trim($lugarreg) . "" . $dateregc . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$matrimoniop', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$regpdf', cargor = '$carg', estado = '$est', TipoMargi = 'MSREG', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
