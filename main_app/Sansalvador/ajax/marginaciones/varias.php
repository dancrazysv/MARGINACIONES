...
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " . $folvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2. ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopartuto', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdfvar', cargor = '$carg', estado = '$est', TipoMargi = 'MRECO', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tipovar == 'subsi' and $tipovareje == 'ejecuvar' and $tipovarsen == 'ejecuvar2') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " . $folvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2 . ", según sentencia pronunciada" .  $hora_var . "" . $datevar . "" . $por_var . "; ejecutoriada" . $hora_vari . "" . $datevari . "" . $por_vari . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopartuto', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdfvar', cargor = '$carg', estado = '$est', TipoMargi = 'MSUB', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tipovar == 'subsi' and $tipovareje == 'ejecuvar' and $tipovarsen == '') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " . $folvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2 . ", según sentencia pronunciada" .  $hora_var . "" . $datevar . "" . $por_var . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'subsi' and $tipovareje == '' and $tipovarsen == 'ejecuvar2') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida queda cancelada por la número " . $numvar2 . ", folio " .  $folvar2 . ", libro número " . $librovar2 . " de Nacimientos, del año " . $aniovar2 . ", ejecutoriada" . $hora_vari . "" . $datevari . "" . $por_vari . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'adop' and $tipovareje == 'ejecuvar' and $tipovarsen == 'ejecuvar2') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "Cancelase la presente partida. Según sentencia pronunciada" .  $hora_var . "" . $datevar . "" . $por_var . "; ejecutoriada" . $hora_vari . "" . $datevari . "" . $por_vari . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopartuto', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdfvar', cargor = '$carg', estado = '$est', TipoMargi = 'MADO', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tipovar == 'adop' and $tipovareje == 'ejecuvar' and $tipovarsen == '') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "Cancelase la presente partida. Según sentencia pronunciada" .  $hora_var . "" . $datevar . "" . $por_var . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
if ($tipovar == 'adop' and $tipovareje == '' and $tipovarsen == 'ejecuvar2') {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "Cancelase la presente partida. Según sentencia ejecutoriada" . $hora_vari . "" . $datevari . "" . $por_vari . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
...
$antecedetres = " y ";
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 =  trim(titleCase($menorvar)) . "" . $sexovar . "" . trim(titleCase($madrevar)) . " ".$antecedetres. " " . trim(titleCase($padrevar)) . ", ha sido" . $legivar . "por matrimonio de sus padres" . $datevars . ", ante " . trim(titleCase($nombrevar)) . ", " . $lugarlegi . "" . trim($lugarvar) . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopartuto', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdfvar', cargor = '$carg', estado = '$est', TipoMargi = 'MLEG', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
...
if ($tipovar == 'repo' ) {
	...
	$id=intval($_POST['edit_idvar']);
	// UPDATE data into database
$TxtMargi1 = "La presente partida ha sido repuesta por la número " . $numvar2 . ", folio " . $folvar2 . ", libro número " . $librovar2 . " de Reposiciones, del año " . $aniovar2 . ", según" . $tipoacta . "" . $actavar2 . "," . $fecharepo . ". Registro del Estado Familiar del Municipio de San Salvador Centro, San Salvador, " . $dia_actual . "" . $mes_actual . "" . $anio_actual.".";
		

	$sql = "UPDATE margi SET TxtMargi1 = '" . Espacios($TxtMargi1) . "', AnioP = '$AnioP', LibroP = '" . Espacios($LibroP) . "', NPartida = '" . Espacios($NPartida) . "', InicialesPDF = '$Iniciales', FechaC = '$fechaActual2', TipoP = '$tipopartuto2', HoraC = '$hora', lineapdf = '$lin', registrador = '$jefer', nmargpdf = '$margpdfvar', cargor = '$carg', estado = '$est', TipoMargi = 'MREPO', revestado = 'revisado1', lugar= '$tipousers' WHERE id = '$id' AND Iniciales1 = '$Iniciales'";
