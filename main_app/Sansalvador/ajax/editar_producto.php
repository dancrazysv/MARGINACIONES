...
$lin = "FIRMACMARGI.jpg";
$jefer = "Licda. Karla Mariela Olivares Martínez";
$carg = "Registrador del Estado Familiar de San Salvador Centro";
...
$nunactaidentidaduno = ( empty($_POST['edit_nid']) )   ? NULL : $_POST['edit_nid'];
$nunactaidentidaddos = ( empty($_POST['edit_nid2']) )   ? NULL : $_POST['edit_nid2'];


$numactaiden = numtoletras($nunactaidentidaduno);

if ($numactaiden == "veintidos"){
	$niden  = "veintidós";
	} else if ($numactaiden == "dieciseis"){
	$niden = "dieciséis";
	} else if ($numactaiden == "veintitres"){
	$niden = "veintitrés";
	} else if ($numactaiden == "veintiseis"){
	$niden = "veintiséis";
	} else{
	$niden  = $numactaiden;
	}
...
$numactaiden2 = numtoletras($nunactaidentidaddos);

if ($numactaiden2 == "veintidos"){
	$niden2  = "veintidós";
	} else if ($numactaiden2 == "dieciseis"){
	$niden2 = "dieciséis";
	} else if ($numactaiden2 == "veintitres"){
	$niden2 = "veintitrés";
	} else if ($numactaiden2 == "veintiseis"){
	$niden2 = "veintiséis";
	} else{
	$niden2  = $numactaiden2;
	}
...
$pardef = " número " . $numpcdef2 . ", folio " . $foliocdef2 . ", libro " . $librocdef2 . ", del año " . $aniocdef2 . ", inscrita en el Registro del Estado Familiar del " . trim($alcaldiacd) . "";
...
$pardef = " ". $aniocdefo . ", inscrita en el Registro del Estado Familiar del " . trim($alcaldiacdo) . "";		
...
if ($sexocdfaX == "male" ){
	$sexocdfa = "del cónyuge";


	}
	else if ($sexocdfaX == "male" ){
	$sexocdfa = "del cónyuge";
	...
	if ($sexocdfaX == "female" ){
		...
		$sexocdfa = "de la cónyuge";
		
	}
else if ($sexocdfaX == "female" ){
	$sexocdfa = "de la cónyuge";
...
$pardefad = " número " . $numpcdefad2 . ", folio " . $foliocdefad2 . ", libro " . $librocdefad2 . ", del año " . $aniocdefad2 . ", extendida por el Registro del Estado Familiar del " . trim($alcaldiaad) . "";
...
$pardefad = " ". $aniocdefoad . ", extendida por el Registro del Estado Familiar del " . trim($alcaldiacdoad) . "";		
...
if ($nombre171 == ""){
	$nombre171 = "";
		...
		$nombre171 = trim(titleCase($nombre171));
	}
...
$tipodocmatri = ( empty($_POST['tipodoc']) )   ? NULL : $_POST['tipodoc'];
...
$uapellidos = "La inscrita se identificará con sus apellidos de soltera,";
...
$uapellidos = "La inscrita se identificará agregando a continuación de su primer apellido de soltera, el primero de su cónyuge,";	
...
$uapellidos = "La inscrita se identificará con su primer apellido de soltera, agregando a continuación el primero de su cónyuge precedido de la partícula DE,";		
...
if ($cargoopcion == 'ccargo' and $nombreopcion == 'mnombre' ){
	...
	$opcionnotario =   titleCase(trim($_POST['Nnotario']));
	$casootro =  ", ante " . trim($optioncaso) . " ";
...
$numescrirecti= numtoletras($lugarrecti);

if ($numescrirecti == "veintidos"){
	$numesrectin = "veintidós";
	} else if ($numescrirecti == "dieciseis"){
	$numesrectin = "dieciséis";
	} else if ($numescrirecti == "veintitres"){
	$numesrectin= "veintitrés";
	} else if ($numescrirecti == "veintiseis"){
	$numesrectin = "veintiséis";
	}
	else{
	$numesrectin = $numescrirecti;
	}
